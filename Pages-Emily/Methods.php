<?php
	...
	function createToolbar() {
		...
		echo "<h1><a href='main_page.php'>LOGO</a></h1>";
		echo "</div>";
		echo "<div id=\"toolbar_searchBar\">";
		echo "<input type=\"text\" placeholder=\"Search\">";
		echo "<button id=\"searchButton\"><a href='search_page.php'>Search</a></button>";
		echo "</div>";
		echo "<div id=\"toolbar_user\">";
		echo "	<p>Hi user! | <a href='logout_page.php'>Logout</a></p>";
		echo "</div>";
		echo "<div id=\"toolbar_buttons\">";
		echo "	<div id=\"toolbar_yourEventButton\">";
		echo "	<h5><a href='event_page.php'>YOUR EVENT</a></h5>";
		echo "	</div>";
		echo "	<div id=\"toolbar_yourBookingButton\">";
		echo "	<h5><a href='booking_page.php'>YOUR BOOKING</a></h5>";
		echo "	</div>";
	...
	function createEventBook($row) {
		...
		echo "<a href='booking_page.php?event_id=$event_id'><h2>Book now</h2></a>";
		echo "</div>";
		echo "</div>";
	}
