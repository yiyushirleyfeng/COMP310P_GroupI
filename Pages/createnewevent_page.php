...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	//Error variables used for error handling in the form
    ...
    if (empty($_POST["category"]) or $_POST['category'] == 'Choose'){
        $categoryErr ="Choose category";
    }
    else {
        $category=test_input($_POST["category"]);
    }
    if (empty($_POST["venue_id"]) or $_POST['venue_id'] == 'Choose'){
	...
	if (strtotime($date) < strtotime($deadline)) {
		$invdateErr = "Date should be later than purchase deadline";
	}
	if (strtotime($stime) > strtotime($etime)) {
		$invtimeErr = "End time should be later than start time";
	}
	if ($eventnameErr or $dateErr or $stimeErr or $etimeErr or $categoryErr or $venue_idErr or $contactErr or $extraErr or $deadlineErr or $noticketsErr or $ticketpriceErr or $invdateErr or $invtimeErr) {
		echo "<p>Please enter the fields correctly</p>";
	}
	else {
    ...
    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
       ...
       <p>
        ...
        <p>
            ...
            <span class="error">* <?php echo $etimeErr;?> <?php echo $invtimeErr;?></span>
        </p>
		...
		?>
            ...
            <span class="error">* <?php echo $venue_idErr;?></span>
        </p>
        ...
        <p>
            ...
            <span class="error">* <?php echo $deadlineErr;?> <?php echo $invdateErr; ?></span>
        </p>
